...
const prepareWAMessageMedia = async (message, options) => {
    ...
    if (!mediaType && 'groupStatusMessage' in message) {
        const statusKeys = Object.keys(message.groupStatusMessage);
        mediaType = statusKeys.find(k => Defaults_1.MEDIA_KEYS.includes(k)) || 'text';
    }
